      ...
      {enabled && (
        <div className="w-full flex gap-2">
          ...
          <div className="flex gap-2 items-center">
            <Input
              type="time"
              className="w-[90px] [&::-webkit-calendar-picker-indicator]:invert"
              value={time}
      ...
      <div className="container mx-auto px-4 py-8 max-w-xl">
        <div className="mb-6">
          ...
          {isEditMode ? (
            <>
              {eventData.id && (
                <p className="text-sm text-muted-foreground mt-1">ID: {eventData.id}</p>
              )}
              {eventData.createdAt && (
            ...
            <p className="text-sm text-muted-foreground mt-1">Fill out the form below to create your event</p>
          )}
        </div>
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-muted-foreground text-xs">
              The date and time that ticket sales close.
            </p>
          </div>
            ...
            <Card className="border-border bg-card">
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                ...
                <DialogContent className="bg-card border-border">
                  <DialogHeader>
                    <DialogTitle className="font-display">Add Ticket Type</DialogTitle>
          ...
          <div>
            <Button onClick={handleFormSubmit} className="cursor-pointer">
